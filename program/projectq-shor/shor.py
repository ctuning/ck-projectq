...
if __name__ == "__main__":
    ...
    if ibm_device in ["ibmqx2", "ibmqx4", "ibmqx5"]:
        print("IBM Backend")
        eng = MainEngine(IBMBackend(use_hardware=False, num_runs=1, device=ibm_device), setup=projectq.setups.ibm)
    else: 
...
#    N = int(input('\n\tNumber to factor: '))
    ...
    if verbose is True: print(resource_counter)  # print resource usage
    print("Run Shor in: %f sec" % shor_run_time)
    print("Verbose: ", verbose, sep="")
    print("IBM Device: ", ibm_device, sep="")
